    ...
    return new Promise((resolve, reject) => {
        ...
        img.onload = async () => {
            ...
            if (getPalette) {
                ...
                const {palette, hasTransparency} = await colorThief.getPalette(img, 4, 10, false, true, {pixelConsideredTransparentThreshold : 255, imageConsideredTransparentThreshold : 0})
